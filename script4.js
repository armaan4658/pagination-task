var data = [
  ...
  var navContent = ()=>{
    ...
    a[0].innerHTML = "<h4>Prev</h4>"
    a[5].innerHTML = "<h4>Next</h4>"
    for(let i = 1; i < 5; i++){
        a[i].innerHTML = `<h4>${i}</h4>`;
    }
  }
  var setNavLink = ()=>{
    var a = document.querySelectorAll("a");
    a[1].setAttribute("href","index.html");
    for (let i = 2 ; i < a.length-1 ; i++){
        var link = `page${i}.html`;
